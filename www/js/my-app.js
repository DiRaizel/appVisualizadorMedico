...
function cargarListaVisualizadores(valor) {
    //
    app.request.post(urlServer + 'Read/cargarListaVisualizadores', {},
            function (rsp) {
                //
                var data = JSON.parse(rsp);
                //
...
function traerIpVisualizador() {
    //
    app.request.post(urlServer + 'Read/traerIpVisualizador', {visualizador: visualizador},
            function (rsp) {
                //
                var data = JSON.parse(rsp);
                //
...
function cargarVideos() {
    //
    app.request.post(urlServer + 'Read/cargarVideos', {visualizador: visualizador},
            function (rsp) {
                //
                var data = JSON.parse(rsp);
                //
...
function cargarConfig() {
    //
    app.request.post(urlServer + 'Read/cargarConfig', {visualizador: visualizador},
            function (rsp) {
                //
                var data = JSON.parse(rsp);
                //
...
function consultarTurnos() {
    //
    app.request.post(urlServer + 'Read/cargarTurno', {visualizador: visualizador},
            function (rsp) {
                //
                var data = JSON.parse(rsp);
                //
